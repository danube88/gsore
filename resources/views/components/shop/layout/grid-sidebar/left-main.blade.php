            ...
            <div class="row flex-column-reverse flex-lg-row">
                                ...
                                <div class="col-12">
                                    <div class="sidebar__banner">
                                        <a href="product-single-default.html" class="banner__link text-center">
                                            <img class="img-fluid" src="{{ config('app.url') }}/img/banner/size-port/img-sidebar.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="sidebar__post-product list-space--medium ">
                                <li  class="d-flex align-items-center">
                                    <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                        <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-1.jpg" alt="">
                                    </a>
                                ...
                                <li  class="d-flex align-items-center">
                                    <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                        <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-2.jpg" alt="">
                                    </a>
                                ...
                                <li  class="d-flex align-items-center">
                                        <a href="product-single-default.html" class="sidebar__product-img img-responsive">
                                            <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-3.jpg" alt="">
                                        </a>
                                    <!-- Start Product Content -->
                                    <div class="product__content">
                ...
                <div class="col-lg-9">
                    <div class="img-responsive">
                        <img src="{{ config('app.url') }}/img/banner/size-wide/banner-shop-1-img-1-wide.jpg" alt="">
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-6.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-7.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                                <span class="product__label product__label--sale-dis">-34%</span>
                                                <!-- End Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-8.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-9.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-10.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                                <span class="product__label product__label--sale-out">Soldout</span>
                                                <!-- End Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-1.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                                <span class="product__label product__label--sale-dis">-34%</span>
                                                <!-- End Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-2.jpg" alt="">
                                                </a>
                                                <!-- Start Product Action Link-->
                                                <ul class="product__action--link pos-absolute">
                                                    <li><a href="#modalAddCart" data-toggle="modal"><i class="icon-shopping-cart"></i></a></li>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-3.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__box product__default--single text-center">
                                            ...
                                            <div class="product__img-box  pos-relative">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-4.jpg" alt="">
                                                </a>
                                                <!-- Start Product Action Link-->
                                                <ul class="product__action--link pos-absolute">
                                                    <li><a href="#modalAddCart" data-toggle="modal"><i class="icon-shopping-cart"></i></a></li>
                                    ...
                                    <div class="col-12">
                                        <div class="product__box product__box--list">
                                            ...
                                            <div class="product__img-box  pos-relative text-center">
                                                <a href="product-single-default.html" class="product__img--link">
                                                    <img class="product__img img-fluid" src="{{ config('app.url') }}/img/product/size-normal/product-home-1-img-5.jpg" alt="">
                                                </a>
                                                <!-- Start Procuct Label -->
