                    ...
                    <tbody>
                        <tr>
                            <td class="product-thumbnail">
                                <a href="#"><img class="img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-1.jpg" alt=""></a>
                            </td>
                        ...
                        <tr>
                            <td class="product-thumbnail">
                                <a href="#"><img class="img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-2.jpg" alt=""></a>
                            </td>
                            <td class="product-name"><a href="#">Product Name</a></td>
                        ...
                        <tr>
                            <td class="product-thumbnail">
                                <a href="#"><img class="img-fluid" src="{{ config('app.url') }}/img/product/size-small/product-home-1-img-3.jpg" alt=""></a>
                            </td>
                            <td class="product-name"><a href="#">Product Name</a></td>
